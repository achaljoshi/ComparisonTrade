...
def main():
    ...
    parser.add_argument(
        "--directory_config", required=True, help="Path to directory_config.json"
    )
    parser.add_argument(
        "--job_response", required=True, help="Path to job_creation_response.json"
    )
    parser.add_argument(
        "--rules_config", required=True, help="Path to rules_config.json"
    )
    parser.add_argument(
        "--output", default="discrepancy_report.csv", help="Output file path"
    )
    parser.add_argument(
        "--file_type",
